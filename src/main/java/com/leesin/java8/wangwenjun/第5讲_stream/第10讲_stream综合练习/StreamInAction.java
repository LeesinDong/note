...
public class StreamInAction {
    public static void main(String[] args) {
        ...
        //4.Return a string of all traders’ names sorted alphabetically   返回按字母顺序排列的所有交易员姓名的字符串
        ...
        //5. Are any traders based in Milan?  是否有traders是米兰的
        ...
        //6.Print all transactions’ values from the traders living in Cambridge.  交易员在剑桥的的交易
        transactions.stream().filter(t -> t.getTrader().getCity().equals("Cambridge"))
                .map(Transaction::getValue)
                .forEach(System.out::println);


        //7.What’s the highest value of all the transactions? 找出最高的交易
        /**
         * 最大的首先想到reduce
         */
        ...
        //8.Find the transaction with the smallest value. 最小的
