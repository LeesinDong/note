package com.leesin.guava.第8讲_collections.FluentIterable;
 ...
 * QQ群:463962286
 ***************************************/
public class FluentIterableExampleTest略
{
    // cr 本质：相当于java8 stream 对iterator的流操作 iterator（list、linkedList、arrayList等）
    ...
    {
        FluentIterable<String> fit = build();
        // 不断的循环 相当于 Stream.iterate(0, n -> n + 2).limit(10);
